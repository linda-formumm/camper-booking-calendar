  ...
  return (
    <main className="relative min-h-[calc(80vh-200px)]">
      ...
      <section className="relative h-[720px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-orange-200 via-pink-200 to-blue-200 opacity-10 dark:from-black/30 dark:via-black/20 dark:to-black/60 dark:opacity-100 z-10" aria-hidden="true" />
